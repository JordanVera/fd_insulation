        ...
        <div className="mx-auto max-w-6xl px-4 py-14 md:px-6">
          <FadeIn>
            ...
            <h1 className="font-heading text-4xl font-bold tracking-tight md:text-5xl">
              Get your{' '}
              <span className="fdi-text">free estimate</span>
            </h1>
            <p className="mt-4 max-w-2xl text-base text-muted-foreground">
              Schedule a free on-site comfort inspection. We serve Houston and DFW metro
              areas — most projects are completed in a single day.
            </p>
          </FadeIn>
        </div>
      </div>
            ...
            <CardContent className="space-y-5 p-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <a href={site.phones.houston.href} className="flex items-start gap-3 transition-colors hover:text-primary">
                    <div className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary/10">
                      <PhoneIcon className="size-4 text-primary" />
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground">Houston</p>
                      <p className="font-semibold">{site.phones.houston.display}</p>
                    </div>
                  </a>
                  <a href={site.phones.dfw.href} className="flex items-start gap-3 pl-11 transition-colors hover:text-primary">
                    <div>
                ...
                <a href={`mailto:${site.email}`} className="flex items-start gap-3 transition-colors hover:text-primary">
                  <div className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary/10">
                    <MailIcon className="size-4 text-primary" />
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">Email</p>
                    <p className="break-all text-sm font-medium">{site.email}</p>
                  </div>
                </a>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">Houston, TX & DFW metroplex</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary/10">
            ...
            <CardContent className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">Flexible financing options available for all insulation projects. Ask us for details.</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <FadeIn delay={0.08} className="lg:col-span-2">
          <Card className="shadow-md dark:shadow-none">
            <CardContent className="p-6 md:p-8">
              <h2 className="mb-6 text-xl font-bold">Tell us about your insulation needs</h2>
              <LeadForm />
            </CardContent>
          </Card>
        </FadeIn>
